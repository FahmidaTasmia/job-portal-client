...
const Header = () => {
    ...
    return (
       <div >
         <div className="navbar text-emerald-800 font-bold flex justify-between z-40  ">
            ...
            <div className="dropdown">
                ...
                <Link to="/" className="btn btn-ghost normal-case text-2xl ">Job<span className='text-black'>Lab</span></Link>
            </div>
